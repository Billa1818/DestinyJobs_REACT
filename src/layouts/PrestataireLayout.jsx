          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2">
                <li><Link to="/prestataire" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Tableau de bord</Link></li>
                <li><Link to="/prestataire/services" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Mon portfolio</Link></li>
                <li><Link to="/prestataire/demandes" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Mes candidatures</Link></li>
                <li><Link to="/consultation" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Consultations</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2">
                ...
                <li><Link to="/a-propos" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">À propos</Link></li>
              </ul>
            </div>
