  ...
  return (
    <div className="min-h-full bg-gray-50 flex flex-col">
      ...
      <header className="bg-white shadow-md sticky top-0 z-50">
        ...
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
          <div className="flex justify-between items-center py-2 sm:py-3 lg:py-4">
            ...
            <div className="flex items-center min-w-0 flex-1 sm:flex-initial">
              <Link to="/home">
                <img src="/img/Logo Normal.svg" alt="Destiny Jobs" className="h-10 w-10 xs:h-16 xs:w-16 sm:h-20 sm:w-20" />
              </Link>
            </div>
            ...
            <nav className="hidden xl:flex space-x-4 2xl:space-x-6">
              ...
              <Link to="/about" className="text-gray-700 hover:text-fuchsia-600 px-2 py-2 rounded-md text-sm font-medium transition duration-200">
                À propos
              </Link>
            ...
            <div className="hidden lg:flex items-center space-x-2 xl:space-x-3">
              <Link to="/login" className="text-fuchsia-600 hover:text-fuchsia-800 font-medium text-sm transition duration-200 px-2 py-1">
                Connexion
              </Link>
              <div className="relative group">
                <button className="bg-fuchsia-600 hover:bg-fuchsia-700 text-white px-3 xl:px-4 py-2 rounded-md text-sm font-medium transition duration-200 flex items-center">
                  Inscription <i className="fas fa-chevron-down ml-1 text-xs"></i>
                </button>
                <div className="dropdown-menu absolute right-0 mt-2 w-40 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible z-10">
                  <div className="py-1">
                    <Link to="/signup/candidat" className="block px-4 py-2 text-sm text-gray-700 hover:bg-fuchsia-50 hover:text-fuchsia-600">Candidat</Link>

                    <Link to="/signup/prestataire" className="block px-4 py-2 text-sm text-gray-700 hover:bg-fuchsia-50 hover:text-fuchsia-600">Prestataire</Link>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex lg:hidden items-center space-x-1 sm:space-x-2">
              <Link to="/login" className="text-fuchsia-600 hover:text-fuchsia-800 font-medium text-xs sm:text-sm transition duration-200 px-1 sm:px-2 py-1 touch-target flex items-center justify-center">
                <span className="hidden xs:inline">Connexion</span>
                <i className="fas fa-sign-in-alt xs:hidden"></i>
              </Link>
              <button 
                onClick={() => setAuthMenuOpen(!authMenuOpen)}
                className="bg-fuchsia-600 hover:bg-fuchsia-700 text-white px-2 sm:px-3 py-1.5 sm:py-2 rounded-md text-xs sm:text-sm font-medium transition duration-200 touch-target relative"
                data-menu="auth"
              >
                <span className="hidden xs:inline">Inscription</span>
                <i className="fas fa-user-plus xs:hidden"></i>
        ...
        {/* Mobile Auth Menu */}
        <div className={`lg:hidden mobile-menu-slide bg-white border-t border-gray-200 ${authMenuOpen ? 'show' : ''}`}>
          <div className="px-2 py-2 space-y-1">
            <Link to="/signup/candidat" className="block px-3 py-2 text-sm text-gray-700 hover:text-fuchsia-600 hover:bg-fuchsia-50 rounded-md">Candidat</Link>
            
            <Link to="/signup/prestataire" className="block px-3 py-2 text-sm text-gray-700 hover:text-fuchsia-600 hover:bg-fuchsia-50 rounded-md">Prestataire</Link>
          </div>
        </div>
        ...
        <div className={`xl:hidden mobile-menu-slide bg-white border-t border-gray-200 ${mobileMenuOpen ? 'show' : ''}`}>
          <div className="px-2 py-2 space-y-1">
            ...
            <Link to="/about" className="block px-3 py-2 text-sm text-gray-700 hover:text-fuchsia-600 hover:bg-fuchsia-50 rounded-md">À propos</Link>
