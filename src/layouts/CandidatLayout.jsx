          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2">
                <li><a href="/candidat" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Tableau de bord</a></li>
                <li><a href="/candidat/applications" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Mes candidatures</a></li>
                <li><a href="/candidat/profile" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Mon profil</a></li>
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2">
                <li><a href="/jobs" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Emplois</a></li>
                <li><a href="/financements" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Financements</a></li>
                <li><a href="/bourses" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Bourses</a></li>
                <li><a href="/consultation" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Consultation</a></li>
              </ul>
            </div>
