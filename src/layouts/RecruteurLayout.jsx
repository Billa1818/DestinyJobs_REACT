          ...
          <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2">
                <li><a href="/recruteur" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Tableau de bord</a></li>
                <li><a href="/recruteur/creer-offre" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Créer une offre</a></li>
                <li><a href="/recruteur/candidatures" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Candidatures</a></li>
                <li><a href="/recruteur/statistiques" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Statistiques</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2">
                <li><a href="/recruteur/gestion-offres" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Gestion des offres</a></li>
                <li><a href="/recruteur/gestion-financements" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Financements</a></li>
                <li><a href="/recruteur/gestion-bourses" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Bourses</a></li>
                <li><a href="/recruteur/gestion-consultations" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Consultations</a></li>
              </ul>
            </div>
