      ...
      <footer className="bg-gray-900 text-white mt-6 sm:mt-8">
        <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-6 sm:py-8 lg:py-12">
          <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            ...
            {/* Quick Links */}
            <div>
              <h3 className="text-sm xs:text-base sm:text-lg font-semibold mb-2 sm:mb-3 lg:mb-4">Recruteur</h3>
              <ul className="space-y-1 sm:space-y-2">
                <li><Link to="/recruteur" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Tableau de bord</Link></li>
                <li><Link to="/recruteur/creer-offre" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Créer une offre</Link></li>
                <li><Link to="/recruteur/candidatures" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Candidatures</Link></li>
                <li><Link to="/recruteur/statistiques" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Statistiques</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2">
                <li><Link to="/recruteur/gestion-offres" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Gestion des offres</Link></li>
                <li><Link to="/recruteur/gestion-financements" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Financements</Link></li>
                <li><Link to="/recruteur/gestion-bourses" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Bourses</Link></li>
                <li><Link to="/recruteur/gestion-consultations" className="text-gray-300 hover:text-white transition duration-200 text-xs xs:text-sm sm:text-base">Consultations</Link></li>
              </ul>
            </div>
