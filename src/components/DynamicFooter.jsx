...
const DynamicFooter = ({ accountType: propAccountType = null }) => {
    ...
    const routeLabels = {
        ...
        candidat: {
            ...
            'profil': 'Mon profil',
            'offre': 'Les offres',
            'emploi-candidature': 'Emploi candidatures',
            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 py-6 sm:py-8 lg:py-12">
                    ...
                    <div>
                        ...
                        <div className="space-y-2 sm:space-y-3">
                            <div className="flex items-start">
                                ...
                                <span className="text-gray-300 text-xs xs:text-sm sm:text-base">Parakou, Bénin</span>
                            </div>
                            <div className="flex items-center">
                                <i className={`fas fa-phone mr-2 text-${colors.text} text-xs sm:text-sm flex-shrink-0`}></i>
                                <span className="text-gray-300 text-xs xs:text-sm sm:text-base">+229 01 56 56 61 86 </span>
                            </div>
                            <div className="flex items-center">
                                <i className={`fas fa-envelope mr-2 text-${colors.text} text-xs sm:text-sm flex-shrink-0`}></i>
                                <span className="text-gray-300 text-xs xs:text-sm sm:text-base">support@destinyjobs.net</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="border-t border-gray-700 mt-6 sm:mt-8 pt-4 sm:pt-6">
                    <div className="flex flex-col gap-4 sm:flex-row sm:justify-between sm:items-center">
                        {/* Copyright */}
                        <p className="text-gray-400 text-xs sm:text-sm lg:text-base text-center sm:text-left order-2 sm:order-1">
                            © 2026 Destiny Jobs. Tous droits réservés.
                        </p>

                        {/* Legal Links */}
                        <div className="flex flex-col xs:flex-row gap-2 xs:gap-3 sm:gap-4 lg:gap-6 order-1 sm:order-2">
                            <Link
                                to="/mentions-legales"
                                className="text-gray-400 hover:text-white transition duration-200 text-xs sm:text-sm lg:text-base text-center xs:text-left py-1 xs:py-0 px-2 xs:px-0 hover:bg-gray-800 xs:hover:bg-transparent rounded xs:rounded-none"
                            >
                                Mentions légales
                            </Link>
                            <div className="hidden xs:block text-gray-600">|</div>
                            <Link
                            ...
                            <Link
                                ...
                                className="text-gray-400 hover:text-white transition duration-200 text-xs sm:text-sm lg:text-base text-center xs:text-left py-1 xs:px-2 xs:py-0 xs:px-0 hover:bg-gray-800 xs:hover:bg-transparent rounded xs:rounded-none"
                            >
