...
const CandidateSettings = () => {
  ...
  const handleConfirmConversion = async () => {
    try {
      ...
      await conversionService.becomeProvider({
        ...
        specializations: conversionData.specializations,
        hourly_rate: conversionData.hourlyRate,
        daily_rate: conversionData.dailyRate,
        years_experience: conversionData.yearsExperienceProvider,
        availability: conversionData.availability
      });
      ...
      error('Erreur', err.response?.data?.message || 'Impossible de convertir en prestataire');
    } finally {
  ...
  return (
    <BaseSettings userType="CANDIDAT">
      ...
      {/* Section Conversion en Prestataire */}
      <div className="bg-white rounded-lg p-6 shadow-sm mt-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-6">
        ...
        <p className="text-gray-700 mb-6">
          Transformez votre profil de candidat en profil de prestataire et commencez à proposer vos services.
        </p>
      ...
      <ConversionConfirmationModal
        ...
        message={`Êtes-vous sûr de vouloir convertir votre compte en prestataire ? Veuillez vérifier vos informations avant de confirmer.`}
