        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative">
              <button className="p-2 text-gray-700 hover:text-fuchsia-600 hover:bg-fuchsia-50 rounded-md transition-colors">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 py-4">
            <div className="space-y-2">
              ...
              <Link to="/recruteur/messages" className="flex items-center px-4 py-2 text-gray-700 hover:bg-fuchsia-50 hover:text-fuchsia-600">
