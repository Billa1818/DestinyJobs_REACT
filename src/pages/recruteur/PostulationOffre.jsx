...
const PostulationOffre = () => {
    ...
    return (
        <div className="w-full">
            ...
            {/* Alerte si l'offre est fermée */}
            {offreDetails && offreDetails.status === 'CLOSED' && (
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-start justify-between">
                                ...
                                <div className="flex flex-col items-end space-y-2">
                                    <span className={`px-3 py-1 text-sm rounded-full font-medium ${offreDetails.status === 'active' ? 'bg-green-100 text-green-800' :
                                ...
                                <div className="space-y-4">
                                    ...
                                    {offreDetails.cv_required !== undefined && (
                                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                            ...
                                            <span className={`px-2 py-1 text-xs rounded-full font-medium ${offreDetails.cv_required ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                                }`}>
                                    ...
                                    {offreDetails.motivation_letter_required !== undefined && (
                                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                            ...
                                            <span className={`px-2 py-1 text-xs rounded-full font-medium ${offreDetails.motivation_letter_required ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                                                }`}>
                                    ...
                                    {offreDetails.is_urgent !== undefined && (
                                        <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                            ...
                                            <span className={`px-2 py-1 text-xs rounded-full font-medium ${offreDetails.is_urgent ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'
                                                }`}>
            ...
            <div className="bg-white rounded-lg p-4 sm:p-6 shadow-sm mb-4 sm:mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6 p-4 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border border-purple-200">
                        ...
                        <div className="space-y-2">
                            {hideSelected || sortByCompatibility ? (
                                <button
                                    ...
                                    className="px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition duration-200 mr-2"
                                >
                                    <i className="fas fa-undo mr-2"></i>
                            ...
                            <div className="flex flex-col lg:flex-row justify-between">
                                ...
                                <div className="flex flex-row lg:flex-col gap-2 mt-4 lg:mt-0 lg:ml-4">
                                    ...
                                    <button
                                        ...
                                        disabled={!offreId || offreId === 'undefined' || offreDetails?.status === 'CLOSED'}
                                        className={`px-3 py-2 rounded-lg transition duration-200 text-sm font-medium ${!offreId || offreId === 'undefined' || offreDetails?.status === 'CLOSED' ? 'text-gray-400 bg-gray-100 cursor-not-allowed opacity-50' : 'text-green-600 hover:bg-green-50'}`}
                                    >
                                    ...
                                    <button
                                        ...
                                        disabled={!offreId || offreId === 'undefined' || offreDetails?.status === 'CLOSED'}
                                        className={`px-3 py-2 rounded-lg transition duration-200 text-sm font-medium ${!offreId || offreId === 'undefined' || offreDetails?.status === 'CLOSED' ? 'text-gray-400 bg-gray-100 cursor-not-allowed opacity-50' : 'text-red-600 hover:bg-red-50'}`}
                                    >
