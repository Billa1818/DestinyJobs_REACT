      ...
      <div className="flex flex-col xl:flex-row gap-6">
        ...
        <div className="xl:w-1/3">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            ...
            <div className="space-y-3">
              <Link 
                to={`/candidat/financements/${financement.id}/postuler`}
                className="w-full bg-fuchsia-600 text-white py-3 px-4 rounded-lg hover:bg-fuchsia-700 transition duration-200 font-medium inline-block text-center"
              >
