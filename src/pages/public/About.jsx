...
const About = () => {
    ...
    const fetchStats = async () => {
        try {
            ...
            setStats(HomeStatService.getDefaultStats());
        } finally {
            setLoadingStats(false);
        }
    };

    // Fonction pour formater les nombres avec "+"
                        ...
                        <div className="bg-gradient-to-br from-fuchsia-100 to-purple-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 text-center">
                            <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                                ...
                                <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 shadow-sm">
                                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-fuchsia-600 mb-1 sm:mb-2">
                                        {loadingStats ? (
                                            <span className="inline-block">
                                                <i className="fas fa-spinner fa-spin"></i>
                                            </span>
                                        ) : (
                                            formatNumber(stats?.offers?.jobOffers || 0)
                                        )}
                                    </h3>
                                ...
                                {/* Candidats inscrits */}
                                <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 shadow-sm">
                                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-600 mb-1 sm:mb-2">
                                        {loadingStats ? (
                                            <span className="inline-block">
                                                <i className="fas fa-spinner fa-spin"></i>
                                            </span>
                                        ) : (
                                            formatNumber(stats?.users?.candidates || 0)
                                        )}
                                    </h3>
                                ...
                                <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 shadow-sm">
                                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-purple-600 mb-1 sm:mb-2">
                                        {loadingStats ? (
                                            <span className="inline-block">
                                                <i className="fas fa-spinner fa-spin"></i>
                                            </span>
                                        ) : (
                                            formatNumber(stats?.users?.recruiters || 0)
                                        )}
                                    </h3>
                                ...
                                {/* Prestataires */}
                                <div className="bg-white rounded-lg sm:rounded-xl p-3 sm:p-4 lg:p-6 shadow-sm">
                                    <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-orange-600 mb-1 sm:mb-2">
                                        {loadingStats ? (
                                            <span className="inline-block">
                                                <i className="fas fa-spinner fa-spin"></i>
                                            </span>
                                        ) : (
                                            formatNumber(stats?.users?.providers || 0)
                                        )}
                                    </h3>
                                    <p className="text-xs sm:text-sm lg:text-base text-gray-600">Prestataires de services</p>
                                </div>
                            </div>
                        </div>
                    </div>
