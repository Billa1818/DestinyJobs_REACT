...
const Jobs = () => {
    ...
    const formatJobData = (apiJob) => {
        // Déterminer si c'est une offre admin_only
        const isAdminOnly = apiJob.is_admin_only || false;

        // Déterminer le logo : admin_company_logo si admin_only, sinon recruiter.logo
        ...
        return {
            ...
            company: isAdminOnly ? 'Entreprise confidentielle' : (apiJob.recruiter?.company_name || 'Entreprise non spécifiée'),
                                        ...
                                        <div className="p-4 sm:p-6">
                                            <div className="flex items-start space-x-3 sm:space-x-4">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    {/* Company & Location - Masqué si admin_only */}
                                                    {!job.is_admin_only && (
