          ...
          <div className="lg:sticky lg:top-24 space-y-4 sm:space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-sm p-4 sm:p-6">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <Link to="/recruteur" className="flex items-center text-sm sm:text-base text-gray-600 hover:text-fuchsia-600 transition duration-200">
                  <i className="fas fa-building mr-2 sm:mr-3 text-green-600 flex-shrink-0"></i>
