        ...
        <div className="flex-1 p-4 lg:p-6 max-w-7xl mx-auto w-full">
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden mb-8 group hover:shadow-xl transition-all duration-300">
                    <div className="relative">
                        {featuredArticle.image ? (
                            ...
                            <div className="w-full h-64 lg:h-80 bg-fuchsia-600 flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
                        ...
                        <div className="absolute top-6 left-6">
                            <span className="bg-fuchsia-600 text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg backdrop-blur-sm">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 mb-8">
                ...
                <div className="xl:col-span-3 space-y-6">
                    {loading ? (
                        <LoadingSpinner variant="inline" size="lg" text="Chargement des articles..." />
                    ) : articles.length === 0 ? (
                        <div className="text-center py-12">
                                ...
                                <div className="flex flex-col lg:flex-row">
                                    ...
                                    <div className="lg:w-2/5 relative overflow-hidden">
                                        {article.image ? (
                                            ...
                                            <div className="w-full h-48 lg:h-full bg-fuchsia-600 flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
                                        ...
                                        <div className="border-t border-gray-100 pt-4">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="flex items-center space-x-3">
                                                    <div className="w-10 h-10 rounded-full bg-fuchsia-600 flex items-center justify-center text-white font-semibold text-sm">
                                                ...
                                                <div className="flex items-center space-x-3">
                                                    ...
                                                    <Link
                                                        ...
                                                        className="bg-fuchsia-600 hover:bg-fuchsia-700 text-white px-6 py-2 rounded-lg font-medium text-sm shadow-md hover:shadow-lg transition-all duration-200 transform hover:scale-105"
                                                    >
                                                        Lire plus
                                                        <i className="fas fa-arrow-right ml-2 group-hover:translate-x-1 transition-transform duration-200"></i>
                                                    </Link>
                            ...
                            {popularArticles.map((article) => (
                                <div key={article.id} className="flex items-start space-x-3">
                                    {article.image ? (
                                        ...
                                        <div className="w-15 h-15 rounded bg-fuchsia-600 flex items-center justify-center flex-shrink-0">
