                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                            {userTypes.map((userType) => (
                                                <div
                                                    key={userType.id}
                                                    className={`border-2 rounded-lg p-4 text-center cursor-pointer transition duration-200 ${formData.user_type === userType.id
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex items-start">
                                            ...
                                            <label htmlFor="terms_accepted" className="ml-2 block text-sm text-gray-700">
                                                J'accepte les{' '}
                                                <Link to="/conditions-utilisation" className="text-fuchsia-600 hover:text-fuchsia-800 font-medium">
                                                    conditions d'utilisation
                                                </Link>{' '}
                                                et la{' '}
                                                <Link to="/politique-confidentialite" className="text-fuchsia-600 hover:text-fuchsia-800 font-medium">
