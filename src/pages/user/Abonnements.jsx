  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
                    ...
                    onClick={() => {
                      if (plan.basePrice === 0) {
                        ...
                        navigate('/plan-manager', {
                          state: {
                            planType: plan.type,
                            userType: selectedProfile.toUpperCase(),
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                answer: 'La visibilité affecte la probabilité que votre profil soit découvert par les recruteurs. Un score de 90/100 signifie une visibilité maximale.'
              },
              {
              ...
              <div key={idx} className="bg-white rounded-lg shadow p-6 border-l-4 border-fuchsia-500">
        ...
        {/* CTA Footer */}
        <div className="mt-16 bg-gradient-to-r from-fuchsia-600 to-fuchsia-700 rounded-xl p-8 text-white text-center">
