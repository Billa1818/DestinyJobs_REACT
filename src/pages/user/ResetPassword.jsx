...
const ResetPassword = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setIsSubmitted(true);
    // Ici vous ajouterez la logique de réinitialisation
  };
              ...
              <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="max-w-md mx-auto">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      type="submit"
                      className="w-full bg-fuchsia-600 text-white py-3 px-4 rounded-lg hover:bg-fuchsia-700 focus:outline-none focus:ring-2 focus:ring-fuchsia-500 focus:ring-offset-2 transition duration-200 font-medium"
                    >
